      ...
      <section id="free" className="py-20 bg-gradient-to-r from-blue-900 to-cyan-900 text-white px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-white/70 mb-12">
            ...
            Join our FREE Online Mentorship Class — 3 months of expert guidance!
            #ForexLearning #UwehsTradeHub
          </p>

          {/* 🖼️ Free Mentorship Banner Image */}
          <div className="mb-12">
            <img
              src="/IMG_6246.jpeg"
              alt="Free Mentorship Banner"
              className="w-full rounded-2xl shadow-lg border border-white/10 hover:shadow-blue-500/30 transition-all duration-500"
            />
          </div>
